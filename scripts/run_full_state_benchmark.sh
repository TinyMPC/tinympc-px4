...
benchmark_binary="$(mktemp "${TMPDIR:-/tmp}/tinympc_full_state_benchmark.XXXXXX")"
...
c++ -std=c++17 -O2 -DNDEBUG \
  ...
  "${quadtest_dir}/wrapper/tinympc_full_state_interface.cpp" \
  "${quadtest_dir}/wrapper/tinympc_full_state_benchmark.cpp" \
